  ...
  <header class="bg-white border-b shadow-sm fixed top-0 inset-x-0 z-50">
    <div class="max-w-7xl mx-auto h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8">
      <div class="flex items-center space-x-4">
        <a href="feed.html" class="text-2xl font-bold text-indigo-600">NCSTConnect</a>
      ...
      <div class="flex items-center space-x-4">
        <div class="relative">
          ...
          >
            ...
            <router-link to="#" class="block px-4 py-2 text-gray-600 hover:bg-gray-100">
              Settings
            </router-link>
  ...
  <div class="pt-16 max-w-7xl mx-auto flex flex-col lg:flex-row">
    ...
    <aside class="hidden lg:block lg:w-64 bg-white border-r px-4 py-6 space-y-8">
      <div>
        ...
        <nav class="space-y-2">
          <RouterLink to="/feed" class="flex items-center text-gray-600 hover:text-indigo-600">
            <svg
              class="w-5 h-5 mr-2"
              fill="none"
              stroke="currentColor"
          ...
          <RouterLink to="#" class="flex items-center text-gray-600 hover:text-indigo-600">
            <svg
              class="w-5 h-5 mr-2"
              fill="none"
              stroke="currentColor"
          ...
          <RouterLink to="/chat" class="flex items-center text-indigo-600 font-medium">
            <svg
              class="w-5 h-5 mr-2"
              fill="none"
              stroke="currentColor"
          ...
          <RouterLink to="/profile" class="flex items-center text-gray-600 hover:text-indigo-600">
            <svg
              class="w-5 h-5 mr-2"
              fill="none"
              stroke="currentColor"
