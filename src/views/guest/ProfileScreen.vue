  ...
  <header class="bg-white border-b shadow-sm fixed top-0 inset-x-0 z-50">
    <div class="max-w-7xl mx-auto h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8">
      <div class="flex items-center space-x-4">
        <RouterLink to="/feed" class="text-2xl font-bold text-indigo-600"> NCSTConnect </RouterLink>
      ...
      <div class="flex items-center space-x-4">
        <div class="relative">
          ...
          >
            <RouterLink to="/profile" class="block px-4 py-2 text-gray-600 hover:bg-gray-100">
              View Profile
            </RouterLink>

            <RouterLink to="#" class="block px-4 py-2 text-gray-600 hover:bg-gray-100">
              Settings
            </RouterLink>
      ...
      <div>
        ...
        <nav class="space-y-2">
          <router-link
            ...
            :class="$route.path === '/feed' ? 'text-indigo-600 font-medium' : 'text-gray-600'"
          >
            <svg
              class="w-5 h-5 mr-2"
              fill="none"
          ...
          <router-link
            ...
            class="flex items-center hover:text-indigo-600"
            :class="
              $route.path === '/communities' ? 'text-indigo-600 font-medium' : 'text-gray-600'
            "
          >
            <svg
              class="w-5 h-5 mr-2"
          ...
          <router-link
            ...
            class="flex items-center hover:text-indigo-600"
            :class="
              $route.path === '/assignments' ? 'text-indigo-600 font-medium' : 'text-gray-600'
            "
          >
            <svg
              class="w-5 h-5 mr-2"
          ...
          <router-link
            to="#"
            class="flex items-center hover:text-indigo-600"
            :class="$route.path === '/events' ? 'text-indigo-600 font-medium' : 'text-gray-600'"
          >
            <svg
              class="w-5 h-5 mr-2"
              fill="none"
          ...
          <router-link
            to="/chat"
            class="flex items-center hover:text-indigo-600"
            :class="$route.path === '/chat' ? 'text-indigo-600 font-medium' : 'text-gray-600'"
          >
            <svg
              class="w-5 h-5 mr-2"
              fill="none"
          ...
          <router-link
            to="/profile"
            class="flex items-center hover:text-indigo-600"
            :class="$route.path === '/profile' ? 'text-indigo-600 font-medium' : 'text-gray-600'"
          >
            <svg
              class="w-5 h-5 mr-2"
              fill="none"
